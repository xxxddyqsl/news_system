...
export default function Published() {
  ...
  const {setWarperRef,refElem,configurationTable,warperRef,styles,handleDelete} =usePublished({publishState,NewButtonFn:(item:any)=><Button danger onClick={()=>handleDelete(item)}>删除</Button>});
  return (
    <>
