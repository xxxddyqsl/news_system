...
export default function Published() {
  ...
  const {setWarperRef,refElem,configurationTable,warperRef,styles,handlePublish} =usePublished({publishState,NewButtonFn:(item:any)=><Button type='primary'  onClick={()=>handlePublish(item)}>发布</Button>});
  return (
    <>
