...
export const userSlice = createSlice({
    // 命名空间，在调用action的时候会默认的设置为action的前缀 userSlice/changeUserSlice
    name: 'userSlice',
    // 初始值
    initialState: initialState,
    // 这里的属性会自动的导出为 userSlice.actions，在组件中可以直接通过dispatch进行触发
    reducers: {
...
// 导出actions
export const { changeUserSlice } = userSlice.actions;
